          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Bottom Left: Price / Free Tag
                Row(
                  children: [
                    Text(
                      course.priceText.isNotEmpty
                          ? course.priceText
                          : (course.price == 0 ? 'Free' : '₹${course.price.toInt()}'),
                      style: GoogleFonts.plusJakartaSans(
                        fontSize: 15,
                        fontWeight: FontWeight.w800,
                        color: (course.priceText == 'Free' || course.price == 0)
                            ? const Color(0xFF10B981) // Green for Free
                            : const Color(0xFF0F172A), // Dark navy for price
                      ),
                    ),
                  ],
                ),
