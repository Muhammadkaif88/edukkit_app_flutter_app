...
/// Dedicated Popular Courses View All Screen for Edukkit.
/// Displays top-rated courses in a full vertical list using the Edukkit design system.
...
class _PopularCoursesScreenState extends State<PopularCoursesScreen> {
  ...
  void initState() {
    super.initState();
    _popularCourses = CoursesData.getPopularCourses();
  }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Top-rated courses learners love',
                      style: GoogleFonts.plusJakartaSans(
                        fontSize: 13.5,
                        fontWeight: FontWeight.w600,
                        color: const Color(0xFF64748B),
                    ...
                    if (_popularCourses.isEmpty)
                      ...
                      ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          final rawCourse = _popularCourses[index];
      ...
      child: Center(
        child: Column(
          children: [
            ...
            Text(
              'Check back soon for top-rated popular courses.',
